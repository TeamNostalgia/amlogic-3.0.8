...
// Note: change the name in default_osd_name[4, 8, 11] by customers
...
void cec_node_init(hdmitx_dev_t* hdmitx_device)
{
    ...
    aml_write_reg32(P_HHI_HDMI_CLK_CNTL, aml_read_reg32(P_HHI_HDMI_CLK_CNTL) | (0x1<<8));
    aml_write_reg32(P_HHI_GCLK_MPEG2, aml_read_reg32(P_HHI_GCLK_MPEG2) | (0x1<<4));
