...
//extern int m6g38_t10203_lcd_init();
...
static struct battery_parameter g38_t10203_battery = {
    .pmu_twi_id = 2,		//AXP20_I2CBUS
    .pmu_irq_id = INT_WATCHDOG,
    .pmu_twi_addr = AXP20_ADDR,
    .pmu_battery_rdc = 118,     ////150,
    .pmu_battery_cap = 4960,    ////8000,
...
static int g38_t10203_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
  ...
  //.led_control     =  led_control,
    ...
    .pmu_call_back   =  g38_t10203_pmu_call_back,
    .board_battery   = &g38_t10203_battery,
};
...
#ifdef CONFIG_FOCALTECH_CAPACITIVE_TOUCHSCREEN_G38_10203
...
MACHINE_START(MESON6_G38_T10203, "Amlogic Meson6 g38_t10203 customer platform")
