...
static struct battery_parameter g38_t7203_battery = {
...
static int g38_t7203_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
  ...
  //.led_control     =  led_control,
    .soft_limit_to99 =  0,
    .para            =  NULL,                       // para will pass to g38_t7203_pmu_call_back
    .pmu_call_back   =  g38_t7203_pmu_call_back,
    .board_battery   = &g38_t7203_battery,
};
...
#endif
#ifdef CONFIG_GSl1680_CAPACITIVE_TOUCHSCREEN_G38_T7203
    {
...
MACHINE_START(MESON6_G38_T7203, "Amlogic Meson6 g38_t7203 customer platform")
