...
#ifdef CONFIG_SIS_CAPACITIVE_TOUCHSCREEN
...
static struct sis_i2c_rmi_platform_data sis_ts_pdata = {
	.power = power,
	.gpio_irq = PAD_GPIOA_16,
};
...
#ifdef CONFIG_SIS_CAPACITIVE_TOUCHSCREEN
    {
        I2C_BOARD_INFO("sis_i2c_ts", 0x08),
        .irq = INT_GPIO_0,
        .platform_data = (void *)&sis_ts_pdata,
    },
#endif
};
