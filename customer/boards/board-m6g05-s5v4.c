...
static int g05_s5v4_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
  ...
  //.led_control     =  led_control,
    .soft_limit_to99 =  0,
    .para            =  NULL,                       // para will pass to g05_s5v4_pmu_call_back
    .pmu_call_back   =  g05_s5v4_pmu_call_back,
    .board_battery   = &g05_s5v4_battery,
};
...
#endif
#ifdef CONFIG_GSl1680_CAPACITIVE_TOUCHSCREEN_GSL1680_G05_S5V4
    {
...
MACHINE_START(MESON6_G05_N1B, "Amlogic Meson6 G05 customer platform")
