...
Lcd_Config_t m6g24_lcd_config = {
    ...
    .lcd_timing = {      
        .pll_ctrl = 0x223, //clk=33.6MHz, 50.1Hz
        .div_ctrl = 0x18843, 
        .clk_ctrl = 0x1115,  //[19:16]ss_ctrl, [12]pll_sel, [8]div_sel, [4]vclk_sel, [3:0]xd
