...
#if (defined CONFIG_VIDEO_AMLOGIC_CAPTURE_GC2035) //back camera
#define  GC0308_NR  1
#else
#define  GC0308_NR  0
#endif
...
#include "board-m6g05-86c-touch.fw"
};
...
static struct i2c_board_info __initdata aml_i2c_bus_info_a[] = {
...
#ifdef CONFIG_VIDEO_AMLOGIC_CAPTURE_GC2035
	{
		...
		I2C_BOARD_INFO("gc2035_i2c",  0x78 >> 1),//0x3c
