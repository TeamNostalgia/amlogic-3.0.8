...
struct key_data gsl_key_data[MAX_KEY_NUM] = {
	{KEY_MENU, 852-20, 852+20, 47-20, 47+20},
	{KEY_HOMEPAGE, 852-20, 852+20, 95-20, 95+20},	
	{KEY_BACK, 852-20, 852+20, 143-20, 143+20},
...
#else
    input_device->evbit[0] = BIT_MASK(EV_SYN)|BIT_MASK(EV_ABS);
#endif
