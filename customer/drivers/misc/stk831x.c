...
static DEVICE_ATTR(enable, S_IRUGO|S_IWUSR, stk831x_enable_show, stk831x_enable_store);
static DEVICE_ATTR(value, S_IRUGO, stk831x_value_show, NULL);
static DEVICE_ATTR(delay, S_IRUGO|S_IWUSR, stk831x_delay_show, stk831x_delay_store);
static DEVICE_ATTR(cali, S_IRUGO|S_IWUSR, stk831x_cali_show, stk831x_cali_store);
